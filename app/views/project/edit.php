  ...
  <div class="row justify-content-center">
    <div class="col-md-8">
      <div class="card shadow-sm border-0">
        ...
        <div class="card-body">
          <form action="/projet_java/app/project/edit/<?php echo htmlspecialchars($project->id); ?>" method="post">
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <select class="form-select" id="type" name="type">
                <option value="kanban" <?php echo ($project->type === 'kanban') ? 'selected' : ''; ?>>Kanban</option>
              </select>
            </div>

            <div class="d-flex justify-content-between">
              <button type="submit" class="btn btn-success">Update Project</button>
              <a href="/projet_java/app/project/show/<?php echo htmlspecialchars($project->id); ?>" class="btn btn-secondary">Cancel</a>
            </div>
          </form>
        </div>
      </div>
